...
import { registerSchema } from "../../../validations/register.validatons";
import { useForm } from "react-hook-form";
import { yupResolver } from "@hookform/resolvers/yup";
import * as yup from "yup";
import { ToastContainer, toast } from "react-toastify";
import { registerAPI } from "../../../API/registerApi";
import { fetchEmail } from "../../../API/fetchEmailAPI";
...
const Register = () => {
  ...
  const handleRegisterData = async (data) => {
    // api post request sending the data to backend
  ...
  const verifyEmails = async (e) => {
    ...
    //send call the fetch api send the email at  the backend side
    const emailResponse = await fetchEmail(data);
    ...
    <div className="bg-gray-800">
      <div className="p-8 lg:w-1/2 mx-auto">
        <div className="bg-white rounded-t-lg p-8">
          <p className="text-center text-base text-black-800 font-dark">
            Sign up with
          </p>
          <div>
        ...
        <div className="bg-gray-100 rounded-b-lg py-12 px-4 lg:px-24">
          ...
          <form className="mt-6" onSubmit={handleSubmit(handleRegisterData)}>
